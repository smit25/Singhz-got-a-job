...
4. **Generate message** using the 3-sentence framework adapted to the contact type:

   ### Recruiter
   - **Sentence 1 (Fit)**: Direct match criteria — role, relevant experience, availability or location
   - **Sentence 2 (Proof)**: Data point that answers their screening questions before they ask (e.g., "5 years building ML pipelines, currently in New York, available immediately")
   - **Sentence 3 (CTA)**: "Happy to share my CV if this aligns with what you're looking for"

   ### Hiring Manager
   - **Sentence 1 (Hook)**: Specific challenge facing their team (extracted from the JD, company blog, or news)
