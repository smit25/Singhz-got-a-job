...
Table with data and cited sources. If no data is available, say so rather than making it up.
...
- Red-flag questions and how to answer them (e.g., "why do you want to leave your current role?", "do you have direct reports?")
