...
# singhz-got-a-job batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
singhz-got-a-job batch runner — process job offers in batch via claude -p workers
...
main() {
  ...
  echo "=== singhz-got-a-job batch runner ==="
